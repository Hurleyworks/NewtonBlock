         ...
         if (ab >= 0.0f)
         {
            ...
            if (magab2 >= magaabb)
            {
               if ((edge->m_incidentFace > 0) && (edge->m_twin->m_incidentFace > 0))
               {
                  ...
                  if (FindEdge (edge->m_incidentVertex, edge->m_next->m_next->m_incidentVertex))
                  {
                     dgEdge * const openEdge = edge;
                     ...
                     if (ab >= 0.0)
                     {
                        ...
                        if (magab2 >= magaabb)
                        {
                           if (openEdge->m_next->m_next->m_next->m_next != openEdge)
                           {
                              ...
                              if (openEdge->m_prev->m_twin->m_incidentFace > 0)
                              {
                                 dirty = true;
